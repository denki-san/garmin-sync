...
The two examples at the top of this README were generated by `plot`. To
make your own:
...
Gaps are not interpolated — if your device didn't capture a metric on a
given night, the line breaks there. Sparse-data days are visible, not
